                                            ...
                                            <v-card-text>
                                                <v-container>
                                                    <v-form ref="form" v-model="valid" lazy-validation>
                                                        <v-row>
                                                            <v-col cols="12">
                                                                <v-select v-model="editedItem.hospital_name"
                                                                    :items="hospital_items" label="Hospital Name"
                                                                    :rules="nameRules" required></v-select>
                                                            </v-col>
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.doctor_name"
                                                                    :rules="nameRules" label="Doctor Name" required>
                                                                </v-text-field>
                                                            </v-col>

                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.position"
                                                                    :rules="nameRules" label="Position" required>
                                                                </v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                </v-container>
...
@section('page_script')
    <script type="text/javascript" src="/js/doctor_script.js"></script>
@endsection
