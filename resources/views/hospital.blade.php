                                                ...
                                                <v-container>
                                                    <v-form ref="form" v-model="valid" lazy-validation>
                                                        <v-row>
                                                            <!-- <v-col cols="12">
                                                                                                            <v-select
                                                                                                            v-model="editedItem.hospital_name"
                                                            ...
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.hospital_name"
                                                                    :rules="nameRules" label="Hospital Name" required>
                                                                </v-text-field>
                                                            </v-col>
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.hospital_address"
                                                                    :rules="nameRules" label="Hospital Address"
                                                                    required>
                                                                </v-text-field>
                                                            </v-col>
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.hospital_number"
                                                                    :rules="nameRules" label="Hospital Number" required>
                                                                </v-text-field>
                                                            </v-col>
                                                        </v-row>
                                                </v-container>
...
@section('page_script')
    <script type="text/javascript" src="/js/hospital_script.js"></script>
@endsection
