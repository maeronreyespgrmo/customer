                                                        ...
                                                        <v-row>
                                                            ...
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.password"
                                                                    ...
                                                                    @click:append="show1 = !show1" label="Password"
                                                            ...
                                                            <v-col cols="12">
                                                                <v-combobox v-model="editedItem.user_type"
                                                                    :rules="nameRules" :items="user_type_item"
                                                                    label="Select your User Type"></v-combobox>
                                                            </v-col>
