...
<div class="card-tools"> --}}
                        ...
                        <v-data-table :headers="headers" :items="data" sort-by="id" class="elevation-1"
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn v-if="item.comments_status == 1" small class="success" @click="deactivate(item)">
                                    <v-icon small>mdi-thumb-up</v-icon>
                                </v-btn>
                                <v-btn v-else small class="error" @click="activate(item)">
...
@section('page_script')
    <script type="text/javascript" src="/js/comments_css_script.js"></script>
@endsection
