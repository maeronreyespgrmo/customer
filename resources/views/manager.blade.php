                                ...
                                ></v-select>
                                                            ...
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.middle_name"
                                                                    :rules="nameRules" label="Middle Name" required>
                                                                </v-text-field>
                                                            </v-col>
                                                            ...
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.manager_name"
                                                                    :rules="nameRules" label="Manager Name" required>
                                                                </v-text-field>
                                                            </v-col>
...
@section('page_script')
    <script type="text/javascript" src="/js/manager_script.js"></script>
@endsection
