...
<div class="card-tools"> --}}
                        ...
                        <v-dialog v-model="dialog1" max-width="900">
                            <v-card>
                                ...
                                <v-card-actions>
                                    ...
                                    <v-btn color="green darken-1" text @click="filter_btn()">
                                        Ok
                                    </v-btn>
                                </v-card-actions>
                            </v-card>
                        ...
                        <v-data-table :headers="headers" :items="data" sort-by="id" class="elevation-1"
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn v-if="item.comments_status==1" class="success" small @click="deactivate(item)">
                                    <v-icon small>mdi-thumb-up</v-icon>
                                </v-btn>
                                <v-btn v-else class="error" small @click="activate(item)">
...
@section('page_script')
    <script type="text/javascript" src="/js/comments_pss_script.js"></script>
@endsection
