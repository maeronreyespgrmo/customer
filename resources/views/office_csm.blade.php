                                                ...
                                                <v-container>
                                                    <v-form ref="form" v-model="valid" lazy-validation>
                                                        ...
                                                        ></v-select>
                                                            ...
                                                            <v-col cols="12">
                                                                <v-text-field v-model="editedItem.office_name"
                                                                    :rules="nameRules" label="Office Name" required>
                                                                </v-text-field>
                                                            </v-col>

                                                            <!-- <v-col cols="12">
                                                                                                        <v-select v-model="editedItem.manager_name"
                                                                                                            :items="manager_items" label="Manager Name"
...
@section('page_script')
    <script type="text/javascript" src="/js/office_csm_script.js"></script>
@endsection
