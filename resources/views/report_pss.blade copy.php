...
<head>
    <style>
        ...
        @media print {
            br {
                display: none;
                /* Revert display for <br> elements when printing */
            }
...
<body>
    <div class="container md-4">
        ...
        <div>
            ...
            <br>
            <div contenteditable="true" style="padding-bottom:10px">This is to inform you of the
            ...
            <table class="custom-table table-bordered" border=1 style="width: 100%;font-size: 10px;">
                <thead>
                    <tr>
...
<body>
    <div class="container md-4">
        ...
        <table class="custom-table table-bordered" style="width: 100%;font-size: 10px;">
            <thead>
                <tr>
                    <th>TYPE OF SERVICE (URI NG SERBISYO)</th>
                    <th>Average Rating</th>
...
<br>
<br>
<!-- <hr style="background-color:red">wew</hr> -->
<br>
<br>
<br>
<!-- PAGE 3 -->
                ...
                <table border=1>
                    <tr>
                        <td>
                            ...
                            <div style="">
                                <div contenteditable="true" id="municipality">Based on the place of residency,
                                    @foreach ($municipality as $key => $item_cc)
                                        @if (number_format(($item_cc['home_count'] / $municipality_total) * 100, 2, '.', '') != 0)
                                            <b>{{ $item_cc['home_count'] }}</b>
                                            <b>{{ number_format(($item_cc['home_count'] / $municipality_total) * 100, 2, '.', '') }}%</b>
                    ...
                    <tr>
                        <td>
                            <div style="font-size: 7pt;margin-bottom:500px;">
                                <div contenteditable="true"><b>Figure 1-Waiting Time for Medical Intervention</b></div>
                                <div contenteditable="true">
                                    @if ($chart_settings == 'pie')
                                        <div id="chart1"></div>
                                    @else
                                        <div style="width:400px;height:300px"><canvas id="myChart1"></canvas> </div>
                                    @endif
                                </div>
                                <div style="padding-bottom:20px"contenteditable="true">Figure 1-Waiting Time
                                    for Medical
                                    Intervention show
                                    that
                                    <b> {{ $chart1_total[0] }}%</b>of the clients were attended in <b>less than (1)
                                        hour</b>,
                                    <b> {{ $chart1[1] }}%</b>
                                    of the clients were attended in <b>1 to 2 hours</b>, <b> {{ $chart1_total[2] }}
                                        %</b>
                                    of the clients were attended in <b>3 to 4 hours</b>, <b> {{ $chart1_total[3] }}
                                        %</b>
                                    of the clients were attended in <b>5 to 6 hours</b>, <b> {{ $chart1_total[4] }}
                                        %</b>
                                    of the clients were attended in <b>7 to 8 hours</b> and <b> {{ $chart1_total[5] }}
                                        %</b>
                                    of the clients were attended in <b>Not Indicated</b> of the total population
                                </div>
                            </div>
