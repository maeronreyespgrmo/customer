...
<table style="width: 100%;">
        <tr>
            ...
            <td width="15%"><img src="/images/coa-logo.png" height="90"
...
<div>I. Overview</div>
<br>
<div contenteditable="true">The Anti-Red Tape Authority(ARTA) is a national government agency........................ R.A 11032 to monitor and ensure compliance with the national policy of .......... and ease of doing businesss in the philippnies.</div>
<br>
<div contenteditable="true">As stated in the ARTA Memorandum Circular(M.C) No. 2022-02, government agencies shall provide the harmonized CSM survey to clients who have completed a transaction. Per 6.7.3 of ARTA M.C No. 2019-002, the client satisfaction measurement detailing the scope and period covered by the measurement, the methodology use, the results of the measurement, and the interpratation of the data shall be reported to the Authorithy.</div>
<br>
<div contenteditable="true">II. Scope:</div>
<br>
<div contenteditable="true">Arta conducted surveys throughout the uear from Jan, 2022 to Dec 2022</div>
<br>
<div contenteditable="true">Arta surveyed every client that visited the main and regional offices, as well as those that contacted ARTA through email.</div>
<br>
<div contenteditable="true">The survey used the standard harmonized CSM questionnaire. It asked clients demographical questions, three(3) Citizen's Charter question, and eight(8) question related to the following Service Quality Dimensions:</div>
<ol>
...
<table border=1>
<tr>
@foreach($result_no_services as $item)
<tr>
<td>{{$item->service_name}}</td>
</tr>
@endforeach
...
<tr>
<td>Respnsiveness</td>
<td>{{$result_sqd[0]->sqd0_1}}</td>
<td>{{$result_sqd[0]->sqd0_2}}</td>
<td>{{$result_sqd[0]->sqd0_3}}</td>
<td>{{$result_sqd[0]->sqd0_4}}</td>
<td>{{$result_sqd[0]->sqd0_5}}</td>
<td>{{$result_sqd[0]->sqd0_responses}}</td>
<td>{{$result_sqd[0]->sqd0_avg}}</td>
</tr>
<tr>
<td>Reliability</td>
<td>{{$result_sqd[0]->sqd1_1}}</td>
<td>{{$result_sqd[0]->sqd1_2}}</td>
<td>{{$result_sqd[0]->sqd1_3}}</td>
<td>{{$result_sqd[0]->sqd1_4}}</td>
<td>{{$result_sqd[0]->sqd1_5}}</td>
<td>{{$result_sqd[0]->sqd1_responses}}</td>
<td>{{$result_sqd[0]->sqd1_avg}}</td>
</tr>
<tr>
<td>Access and Facilities</td>
<td>{{$result_sqd[0]->sqd2_1}}</td>
<td>{{$result_sqd[0]->sqd2_2}}</td>
<td>{{$result_sqd[0]->sqd2_3}}</td>
<td>{{$result_sqd[0]->sqd2_4}}</td>
<td>{{$result_sqd[0]->sqd2_5}}</td>
<td>{{$result_sqd[0]->sqd2_responses}}</td>
<td>{{$result_sqd[0]->sqd2_avg}}</td>
</tr>
<tr>
<td>Communication</td>
<td>{{$result_sqd[0]->sqd3_1}}</td>
<td>{{$result_sqd[0]->sqd3_2}}</td>
<td>{{$result_sqd[0]->sqd3_3}}</td>
<td>{{$result_sqd[0]->sqd3_4}}</td>
<td>{{$result_sqd[0]->sqd3_5}}</td>
<td>{{$result_sqd[0]->sqd3_responses}}</td>
<td>{{$result_sqd[0]->sqd3_avg}}</td>
</tr>
<tr>
<td>Cost</td>
<td>{{$result_sqd[0]->sqd4_1}}</td>
<td>{{$result_sqd[0]->sqd4_2}}</td>
<td>{{$result_sqd[0]->sqd4_3}}</td>
<td>{{$result_sqd[0]->sqd4_4}}</td>
<td>{{$result_sqd[0]->sqd4_5}}</td>
<td>{{$result_sqd[0]->sqd4_responses}}</td>
<td>{{$result_sqd[0]->sqd4_avg}}</td>
</tr>
<tr>
<td>Integrity</td>
<td>{{$result_sqd[0]->sqd5_1}}</td>
<td>{{$result_sqd[0]->sqd5_2}}</td>
<td>{{$result_sqd[0]->sqd5_3}}</td>
<td>{{$result_sqd[0]->sqd5_4}}</td>
<td>{{$result_sqd[0]->sqd5_5}}</td>
<td>{{$result_sqd[0]->sqd5_responses}}</td>
<td>{{$result_sqd[0]->sqd5_avg}}</td>
</tr>
<tr>
<td>Assurance</td>
<td>{{$result_sqd[0]->sqd6_1}}</td>
<td>{{$result_sqd[0]->sqd6_2}}</td>
<td>{{$result_sqd[0]->sqd6_3}}</td>
<td>{{$result_sqd[0]->sqd6_4}}</td>
<td>{{$result_sqd[0]->sqd6_5}}</td>
<td>{{$result_sqd[0]->sqd6_responses}}</td>
<td>{{$result_sqd[0]->sqd6_avg}}</td>
</tr>
<tr>
<td>Outcome</td>
<td>{{$result_sqd[0]->sqd8_1}}</td>
<td>{{$result_sqd[0]->sqd8_2}}</td>
<td>{{$result_sqd[0]->sqd8_3}}</td>
<td>{{$result_sqd[0]->sqd8_4}}</td>
<td>{{$result_sqd[0]->sqd8_5}}</td>
<td>{{$result_sqd[0]->sqd8_responses}}</td>
<td>{{$result_sqd[0]->sqd8_avg}}</td>
</tr>
<tr>
<td>Outcome</td>
<td>{{$result_sqd[0]->sqd1_avg}}</td>
...
<td>{{$result_sqd[0]->sqd4_avg}}</td>
<td>{{$result_sqd[0]->sqd5_avg}}</td>
<td>{{$result_sqd[0]->response_total}}</td>
<td>{{$result_sqd[0]->total_rating}}</td>
</tr>
...
<br>
<div>As a result, ARTA recorded an Overall score of {{$result_sqd[0]->total_rating}}, which translated to "Very Satisfied"</div>
<br>
...
<tbody>
@foreach($result_average_sqd_external as $item)
<tr>
<td>{{$item->service_name}}</td>
<td>{{$item->sqd_avg}}</td>
</tr>
...
<tbody>
@foreach($result_average_sqd_internal as $item)
<tr>
<td>{{$item->service_name}}</td>
<td>{{$item->sqd_avg}}</td>
</tr>
